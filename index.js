...
const { BufferJSON, WA_DEFAULT_EPHEMERAL, generateWAMessageFromContent, proto, generateWAMessageContent, generateWAMessage, prepareWAMessageMedia, areJidsSameUser, getContentType, makeCacheableSignalKeyStore, makeInMemoryStore, msgRetryCounterCache, useMultiFileAuthState, PHONENUMBER_MCC, DisconnectReason, jidNormalizedUser, jidDecode, downloadContentFromMessage, generateForwardMessageContent, WAMessageKey} = baileys
...
const { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetchJson, await, sleep } = require('./lib/fetcher')
...
uno.sendMessage(jid, buttonMessage, { quoted, ...options });
};
